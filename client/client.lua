		...
		while true do
			...
			if nearBank() or nearATM() then
				...
				if IsControlJustPressed(1, keys[Config.Keys.Open]) then
					openUI()
					TriggerServerEvent('dinero_suiza:balance')
...
RegisterNUICallback('deposit', function(data)
	TriggerServerEvent('dinero_suiza:deposit', tonumber(data.amount))
	TriggerServerEvent('dinero_suiza:balance')
end)
...
RegisterNUICallback('withdrawl', function(data)
	TriggerServerEvent('dinero_suiza:withdraw', tonumber(data.amountw))
	TriggerServerEvent('dinero_suiza:balance')
end)
...
RegisterNUICallback('transfer', function(data)
	TriggerServerEvent('dinero_suiza:transfer', data.to, data.amountt)
	TriggerServerEvent('dinero_suiza:balance')
end)
...
--==         Result   Event                    ==
--===============================================
RegisterNetEvent('dinero_suiza:result')
AddEventHandler('dinero_suiza:result', function(type, message)
